      ...
      <div className="login flex justify-center space-x-28 items-center mt-20">
        <form action=""  method="post">
          ...
          <div className="logbuttons flex flex-row items-start p-2 px-4 gap-1 w-220px h-44px bg-gray-400 rounded-full mt-3" >
            <button variant="primary" className="flex flex-row items-center px-6 py-18 gap-10 w-30 h-10 rounded-full bg-white "  >
              <NavLink to="/">Student</NavLink>
            </button>
            <button variant="primary" className="text-white flex flex-row items-center px-6 py-18 gap-10 w-30 h-10" >
